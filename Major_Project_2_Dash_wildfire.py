#import pip3.11 install setuptools
#import python3.11 -m pip install packaging
#import python3.11 -m pip install pandas dash
#import pip3 install httpx==0.20 dash plotly
